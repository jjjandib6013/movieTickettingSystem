...
public class PaymentConfirmation extends JFrame {
    ...
    public PaymentConfirmation(String movieTitle, int totalTickets, String name, String email, String phone) {
        ...
        String[] paymentMethods = {"Credit Card", "PayPal", "Debit Card"};
